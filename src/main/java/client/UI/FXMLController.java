...
public class FXMLController implements Initializable {
     ...
     */
    private final ObservableList<String> listTypeClient = FXCollections.observableArrayList(TypeAgentClient.Presse, TypeAgentClient.Econome, TypeAgentClient.Mefiant, TypeAgentClient.Negociateur, TypeAgentClient.Fidele);
